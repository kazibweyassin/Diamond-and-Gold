      ...
      <div className="max-w-7xl mx-auto">
        <div className={variant === 'compact' ? 'grid gap-12 md:grid-cols-[2fr_1fr_1fr_1fr_1fr] mb-12' : 'grid gap-12 md:grid-cols-[2fr_1fr_1fr_1fr] mb-12'}>
          <div>
            ...
            <p className="mt-5 text-sm text-white/75 max-w-xs leading-relaxed">{resolvedBrandDescription}</p>
          </div>

          {resolvedSections.map((section) => (
            <div key={section.label}>
              <p className="text-[10px] uppercase tracking-[0.25em] text-white/85 mb-5">{section.label}</p>
              ...
              <div className="flex flex-col gap-3 text-sm">
                {section.links.map((link) => (
                  <Link
                    ...
                    className="inline-flex w-fit max-w-full break-words text-[var(--color-green-tint)] hover:text-[var(--color-green-bright)] transition"
                  >
                    {link.name}
                  </Link>
                ))}
        ...
        <div className="flex flex-col gap-3 border-t border-[var(--color-green-dark)]/40 pt-6 text-[11px] text-white/80 md:flex-row md:items-center md:justify-between">
          ...
          <div className="flex flex-col gap-2 md:flex-row md:items-center md:gap-6">
            <Link href="/privacy-policy" className="inline-flex w-fit text-[var(--color-green-tint)] hover:text-[var(--color-green-bright)] transition">
              Privacy Policy
            </Link>
