...
export default function WhatsAppButton() {
  ...
  return (
    <a
      ...
      className="group fixed bottom-4 right-4 z-50 flex h-14 w-14 items-center justify-center rounded-full bg-[#25D366] shadow-lg transition-all duration-300 hover:scale-110 hover:shadow-xl sm:bottom-6 sm:right-6 md:h-16 md:w-16 ring-4 ring-[#25D366]/20"
    >
      <svg
      ...
      <span className="absolute bottom-full right-0 mb-2 hidden rounded-md bg-gray-800 px-3 py-2 text-sm text-white whitespace-nowrap sm:block group-hover:block">
