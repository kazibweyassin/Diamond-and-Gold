...
export default function WhatsAppButton() {
  ...
  return (
    <a
      ...
      className="group fixed bottom-6 right-6 z-50 flex h-14 w-14 items-center justify-center rounded-full bg-[#25D366] shadow-lg transition-all duration-300 hover:scale-110 hover:shadow-2xl focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-white motion-reduce:scale-100 motion-reduce:transition-none md:h-16 md:w-16"
    ...
    >
      ...
      <span className="pointer-events-none absolute bottom-full right-0 z-20 mb-2 whitespace-nowrap rounded-lg bg-slate-900 px-3 py-2 text-xs font-medium text-white opacity-0 shadow-xl transition-opacity duration-200 group-hover:opacity-100 group-focus-visible:opacity-100 motion-reduce:group-hover:opacity-0 motion-reduce:group-focus-visible:opacity-100">
        Chat with us on WhatsApp
        <span className="absolute -bottom-1 right-4 h-2 w-2 rotate-45 bg-slate-900" aria-hidden="true" />
      </span>

      <span
        className="wa-ping-ring absolute inset-0 animate-ping rounded-full bg-[#25D366] opacity-75"
        aria-hidden="true"
      />
    </a>
  );
