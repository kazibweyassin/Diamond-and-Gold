    ...
    <main style={{ minHeight: '100vh', background: '#F7F6F2', color: '#0D0D0D' }}>
      <style>{`
        *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        .news-hero p { color: rgba(255,255,255,0.7); font-size: 15px; line-height: 1.75; max-width: 600px; position: relative; z-index: 1; }
        ...
        .article-tag { display: inline-block; font-family: ui-monospace, monospace; font-size: 10px; letter-spacing: 0.15em; text-transform: uppercase; color: var(--gold); background: rgba(184,146,42,0.12); padding: 4px 10px; border-radius: 2px; margin-bottom: 0.75rem; width: fit-content; }
        .article-meta { display: flex; align-items: center; gap: 1rem; font-family: ui-monospace, monospace; font-size: 11px; color: rgba(10,22,40,0.6); margin-bottom: 1rem; }
        ...
        .article-excerpt { font-size: 13px; color: rgba(10,22,40,0.7); line-height: 1.65; flex: 1; margin-bottom: 1.25rem; }
